...
ovenReady() {
  ...
  nyanCatPowerUp() {
    this.playMultiTone([
      ...
      { frequency: 622.3, delay: 3964, duration: 0.107, type: 'square', volume: 0.22 },
      { frequency: 740.0, delay: 4071, duration: 0.107, type: 'square', volume: 0.22 },
      { frequency: 554.4, delay: 4179, duration: 0.107, type: 'square', volume: 0.22 },
      { frequency: 587.3, delay: 4286, duration: 0.107, type: 'square', volume: 0.22 },
      { frequency: 493.9, delay: 4393, duration: 0.107, type: 'square', volume: 0.22 },
      { frequency: 554.4, delay: 4500, duration: 0.107, type: 'square', volume: 0.22 },
      { frequency: 622.3, delay: 4607, duration: 0.107, type: 'square', volume: 0.22 },
      { frequency: 587.3, delay: 4714, duration: 0.107, type: 'square', volume: 0.22 },
      { frequency: 554.4, delay: 4821, duration: 0.107, type: 'square', volume: 0.22 },
      { frequency: 493.9, delay: 4929, duration: 0.107, type: 'square', volume: 0.22 },
    ]);
  }
