      ...
      <div className="absolute inset-0 flex items-center justify-between px-4 pt-8 pointer-events-auto">
        ...
        <div className="flex flex-col items-center">
          <button
            ...
            className="w-24 h-[108px] bg-red-500 text-white rounded-t-xl hover:bg-red-600 disabled:opacity-30 disabled:cursor-not-allowed transition-all active:scale-95 active:bg-red-700 flex items-center justify-center text-3xl font-bold shadow-lg border-b border-red-400"
          >
            ↑
          </button>
          <button
            ...
            className="w-24 h-[108px] bg-red-500 text-white rounded-b-xl hover:bg-red-600 disabled:opacity-30 disabled:cursor-not-allowed transition-all active:scale-95 active:bg-red-700 flex items-center justify-center text-3xl font-bold shadow-lg"
          >
            ↓
          </button>
        </div>
